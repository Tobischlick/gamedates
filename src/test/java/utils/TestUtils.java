...
public class TestUtils {
    ...
    public static String DATE_A = "18.06.2023";
    public static String DATE_B = "25.06.2023";

    public static String TIME_A = "09:30";
    public static String TIME_B = "14:00";

    public static String TEAM_A = "Herren";

    public static String HOME_TEAM_A = "TC Karlsruhe-West 1";
    public static String GUEST_TEAM_A = "Karlsruher ETV 3";
